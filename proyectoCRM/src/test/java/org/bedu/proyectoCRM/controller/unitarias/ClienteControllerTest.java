...
import org.bedu.proyectoCRM.controller.ClienteController;
...
class ClienteControllerTest {
    ...
    @Test
    void obtenCliente() throws Exception {
    ...
    void creaCliente() throws Exception {
        Cliente clienteParametro = Cliente.builder().nombre("Nombre").direccion("Direccion").numeroEmpleados("30").correoContacto("contacto@cliente.com").build();
        Cliente clienteRespuesta = Cliente.builder().id(1L).nombre("Nombre").direccion("Direccion").numeroEmpleados("30").correoContacto("contacto@cliente.com").build();
    ...
    void actualizaCliente() throws Exception {
        ...
        Cliente clienteParametro = Cliente.builder().id(1L).nombre("Nombre").direccion("Direccion").numeroEmpleados("30").correoContacto("contacto@cliente.com").build();
